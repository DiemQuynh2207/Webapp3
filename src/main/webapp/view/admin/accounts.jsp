            ...
            <div class="table-data">
				<div class="order">
					...
					<table id="table-product">
						...
						<tbody>
							<c:forEach items="${list}" var="list" varStatus="STT" >
								<tr>
	                                <td>${list.userId }</td>
    ...
    <div id="myModal-add" class="modal">
        ...
        <div class="left">
            ...
            <h2>Thêm tài khoản</h2>
                <form action="account/add" class="form-fill-info" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="info-product">
                        <span>Role</span>
                        <input type="text" placeholder="Nhập Role" name="role" required>
                    </div>
